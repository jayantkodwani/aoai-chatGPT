...
class _UiSettings(BaseSettings):
    ...
    designed to keep all staff informed and engaged. 
    Whether you need insights on company leadership, policies, 
    the latest news, or best practices, this intelligent resource is here to help. 
    
    With seamless access to vital information, interactive guidance, 
    and instant responses, iPay4All GPT empowers employees to stay connected, 
    make informed decisions, and enhance workplace collaboration."""
